...
bool SystemClock_Config(void)
{
    ...
    RCC_OscInitStruct.OscillatorType = RCC_OSCILLATORTYPE_HSE; // HSE reloj externo y LSI RTC interno
    RCC_OscInitStruct.HSEState = RCC_HSE_ON;                   // Habilita HSE
    RCC_OscInitStruct.HSEPredivValue = RCC_HSE_PREDIV_DIV1;    // Se divide por 2 HSE
